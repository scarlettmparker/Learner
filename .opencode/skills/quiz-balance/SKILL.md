...
## Rules
 ...
 - Variable length: 5 for basic/easy, 10 for same/normal, 20 for advanced or mastery. Accept less if you must, but really push to the full count; short at 4 is underwhelming and the driver in code (5/10/20) expects you to count Q1..Qn. `LLM_MAX_OUTPUT_TOKENS=8192` is set so you have room, and reasoning is cheap, so don't stop early.
