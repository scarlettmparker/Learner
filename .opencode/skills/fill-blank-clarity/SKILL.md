...
- Every fill must have a cue right after the blank: "in \_**\_ [year]", "the book \_\_** [work]", "the author \_**\_ [person]", "in \_\_** [city]", "also \_**\_ [concept]" or rephrase as a direct question like "In what year was the treaty signed?" Never leave a bare "also a \_\_**." without a cue. If you use a cue, keep it in brackets right after the blank; don't bury it in the Explain. The learner sees the stem first.
- The word before the blank must agree with the answer. If the blank expects a vowel sound, write "an \_**\_ [concept]" or omit the article and write "also \_\_** [concept]". If it expects a consonant sound, write "a \_\_\_\_ [concept]". Test by inserting the answer: "also an end" is correct, "also a end" is not.
- Don't give the answer away, just the type. "[year]" is enough, not "[year 1919]". The cue must be a TYPE like [year], [person], [work], [concept], never the answer word itself - writing "right \_\_\_\_ [prior]" when the answer is "prior" leaks and will be dropped. And never put the answer in parentheses inside an option. A failure like `The 18th century (1785)` answers itself, so the other centuries are pointless. Keep the option clean: `The 18th century`.
...
- Every fill must be grammatically correct as an intentional fragment. The answer must fit the blank without fixing the grammar yourself. Don't write "would \_**\_ [activity]" and expect a gerund like "undermining the process" when the stem needs a base verb like "undermine". Write "would \_\_** [verb phrase]" for the base form or "would result in \_\_\_\_ [noun phrase]" for the gerund. Test it by reading the stem with the answer inserted; it should sound right.
