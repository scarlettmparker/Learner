...
type Documents = {
    ...
    "mutation BulkCreateQuestions($inputs: [QuestionInput!]!) {\n  questionMutations {\n    bulkCreateQuestions(inputs: $inputs) {\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}": typeof types.BulkCreateQuestionsDocument,
    "query ListQuestions($remoteObject: String, $pagination: PaginationInput) {\n  questionQueries {\n    listQuestions(remoteObject: $remoteObject, pagination: $pagination) {\n      items {\n        id\n        stem\n        answer\n        explanation\n        remoteObject\n        createdAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}": typeof types.ListQuestionsDocument,
    "mutation SubmitAnswer($questionId: ID!, $input: AnswerInput!) {\n  questionMutations {\n    submitAnswer(questionId: $questionId, input: $input) {\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}": typeof types.SubmitAnswerDocument,
...
const documents: Documents = {
    ...
    "mutation BulkCreateQuestions($inputs: [QuestionInput!]!) {\n  questionMutations {\n    bulkCreateQuestions(inputs: $inputs) {\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}": types.BulkCreateQuestionsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation BulkCreateQuestions($inputs: [QuestionInput!]!) {\n  questionMutations {\n    bulkCreateQuestions(inputs: $inputs) {\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}"): (typeof documents)["mutation BulkCreateQuestions($inputs: [QuestionInput!]!) {\n  questionMutations {\n    bulkCreateQuestions(inputs: $inputs) {\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query ListQuestions($remoteObject: String, $pagination: PaginationInput) {\n  questionQueries {\n    listQuestions(remoteObject: $remoteObject, pagination: $pagination) {\n      items {\n        id\n        stem\n        answer\n        explanation\n        remoteObject\n        createdAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"): (typeof documents)["query ListQuestions($remoteObject: String, $pagination: PaginationInput) {\n  questionQueries {\n    listQuestions(remoteObject: $remoteObject, pagination: $pagination) {\n      items {\n        id\n        stem\n        answer\n        explanation\n        remoteObject\n        createdAt\n      }\n      pageInfo {\n        page\n        size\n        totalPages\n        totalCount\n        hasNextPage\n        hasPreviousPage\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation SubmitAnswer($questionId: ID!, $input: AnswerInput!) {\n  questionMutations {\n    submitAnswer(questionId: $questionId, input: $input) {\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}"): (typeof documents)["mutation SubmitAnswer($questionId: ID!, $input: AnswerInput!) {\n  questionMutations {\n    submitAnswer(questionId: $questionId, input: $input) {\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
